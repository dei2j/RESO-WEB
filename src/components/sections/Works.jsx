...
const Works = () => {
  ...
  const works = [
    { title: 'AIA', desc: 'Digital Experience', color: 'bg-[#1907b7]', image: '/img/포트폴리오 썸네일/AIA.webp', caseUrl: '/case/aia' },
    { title: 'KT', desc: 'Digital Experience', color: 'bg-[#ef283f]', image: '/img/포트폴리오 썸네일/KT.webp', caseUrl: '/case/kt' },
    { title: 'Agent F', desc: 'Digital Experience', color: 'bg-black', image: '/img/포트폴리오 썸네일/Agent F.webp', caseUrl: '/case/agent-f' },
    { title: 'Royal Salute', desc: 'Digital Experience', color: 'bg-[#1907b7]', image: '/img/포트폴리오 썸네일/Royal Salute.webp', caseUrl: '/case/royal-salute' },
    { title: 'Zeta Mobility', desc: 'Digital Experience', color: 'bg-[#ef283f]', image: '/img/포트폴리오 썸네일/Zeta Mobility.webp', caseUrl: '/case/zeta-mobility' },
    { title: 'HSBC', desc: 'Digital Experience', color: 'bg-black', image: '/img/포트폴리오 썸네일/HSBC.webp', caseUrl: '/case/hsbc' },
    { title: '프로그래머스', desc: 'Digital Experience', color: 'bg-[#1907b7]', image: '/img/포트폴리오 썸네일/프로그래머스.webp', caseUrl: '/case/programmers' },
    { title: 'Hermes', desc: 'Digital Experience', color: 'bg-[#ef283f]', image: '/img/포트폴리오 썸네일/hermes.webp', caseUrl: '/case/hermes' },
    { title: 'Kumho Tire', desc: 'Digital Experience', color: 'bg-black', image: '/img/포트폴리오 썸네일/Kumho Tire.webp', caseUrl: '/case/kumho-tire' },
    { title: 'CJ 제일제당', desc: 'Digital Experience', color: 'bg-[#1907b7]', image: '/img/포트폴리오 썸네일/CJ 제일제당.webp', caseUrl: '/case/cj' },
    { title: 'Desilo', desc: 'Digital Experience', color: 'bg-[#ef283f]', image: '/img/포트폴리오 썸네일/Desilo.webp', caseUrl: '/case/desilo' },
    { title: 'Takamol', desc: 'Digital Experience', color: 'bg-black', image: '/img/포트폴리오 썸네일/Takamol.webp', caseUrl: '/case/takamol' },
    { title: 'Parc', desc: 'Digital Experience', color: 'bg-[#1907b7]', image: '/img/포트폴리오 썸네일/Parc.webp', caseUrl: '/case/parc' },
    { title: 'Ecover', desc: 'Digital Experience', color: 'bg-[#ef283f]', image: '/img/포트폴리오 썸네일/Ecover.webp', caseUrl: '/case/ecover' },
    { title: 'Rosatis', desc: 'Digital Experience', color: 'bg-black', image: '/img/포트폴리오 썸네일/Rosati_s.webp', caseUrl: '/case/rosatis' },
    { title: 'Guro', desc: 'Digital Experience', color: 'bg-[#1907b7]', image: '/img/포트폴리오 썸네일/guro.webp', caseUrl: '/case/guro' },
    { title: 'CIMB Bank', desc: 'Digital Experience', color: 'bg-[#ef283f]', image: '/img/포트폴리오 썸네일/cimb.webp', caseUrl: '/case/cimb' },
    { title: '한국주택금융공사', desc: 'Digital Experience', color: 'bg-black', image: '/img/Portfolio/한국주택금융공사/Screenshot 2026-03-30 140743.webp', caseUrl: '/case/khfc' },
